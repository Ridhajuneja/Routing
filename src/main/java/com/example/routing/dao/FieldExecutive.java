...
//    private Collection<BikerEntry> locationEntries = new ArrayList<BikerEntry>();
    ...
    public FieldExecutive(Long id, String name, Boolean status, Integer age, String work, String education, String placeLived, String contactNumber, String userName, String password) {
        this.id = id;
        this.name = name;
        this.status = status;
        this.age = age;
